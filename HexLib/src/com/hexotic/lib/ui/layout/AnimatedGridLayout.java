 ...
 * AnimatedGridLayout
 * 
 * Provides a 'grid'/'flow' layout.  Intended for use for organizing
 * Panels for a file or item view.  The times can be comparable and ordered
 * automatically.
 * 
 * @author Bradley Sheets
 *
 */
public class AnimatedGridLayout implements LayoutManager2, Runnable{
    private int vgap = 5;
    private int hgap = 5;
     ...
     * Default attributes will be applied where hgap is 5, vgap is 5, and ordered is 
     * false 
     */
     ...
     * Creates an AnimatedGridLayout
     * 
     * @param vgap Vertical space between components
     * @param hgap Horizontal space between components 
     */
     ...
     * Creates an AnimatedGridLayout
     * 
     * @param ordered If the components are comparable, set to true to order
     */
	...
	public void layoutContainer(Container parent) {
        ...
        for(int i = 0; i < parent.getComponentCount(); i++){
        	...
        	if(!components.containsKey(comp) && comp.isVisible()){
        		...
        		if(!working){ /* If the UI is being updated, we'll add it next time around */
